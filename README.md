...
- Safari: local preview build available from this repo; see below if you want to try it.
...
[![Watch the OverCite demo](docs/assets/overcite-demo-preview-apr20.gif)](docs/assets/overcite-demo-preview-apr20.gif)
