...
const isolatedRoot = await fs.mkdtemp("/private/tmp/overcite-launch-integration-");
const workspaceFilePath = path.join(isolatedRoot, "integration.code-workspace");
const vscodeExecutablePath = "/Users/bijan1339/Downloads/Visual Studio Code.app/Contents/MacOS/Electron";
const testUserDataDir = path.join(isolatedRoot, "user");
const testExtensionsDir = path.join(isolatedRoot, "extensions");
...
try {
  ...
  console.log(JSON.stringify({
    ...
    metadataPickerScenariosPassed: 1
  }, null, 2));
} finally {
